...
ROOT=/nas/longleaf/home/zpopkinh/Pvivax_resources/wgs_qc_new/ # root directory for project (non-scratch)
WD=/pine/scr/z/p/zpopkinh/Pvivax_MIPs/wgs_qc_IDEEL_pe/ # working directory for alignments (scratch)
