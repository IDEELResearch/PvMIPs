...
ROOT=/nas/longleaf/home/zpopkinh/Pvivax_resources/new_seqs_2021/ # root directory for project (non-scratch)
WD=/pine/scr/z/p/zpopkinh/Pvivax_MIPs/wgs_pe_IDEEL_samples/ # working directory for alignments (scratch)
